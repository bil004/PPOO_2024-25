...
public class TestLibraryAccount2 {
    public static void main(String[] args) {
        
        LibraryAccount2 acc1 = new LibraryAccount2("Mario Rossi", 3);
        LibraryAccount2 acc2 = new LibraryAccount2("Luisa Bianchi");
        ...
        System.out.println("\n=== Test LibraryAccountYoung ===");
        LibraryAccountYoung2 youngAcc = new LibraryAccountYoung2("Paolo Piccolo", 3);
