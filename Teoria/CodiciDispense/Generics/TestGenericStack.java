...
import java.util.*;
//in questo modo importiamo anche la classe Random dei generatori di numeri casuali, oltre alle altre util usate nel programma
...
public class TestGenericStack {
    ...
    public static void main(String[] args) {
        ...
        /*
         * Al posto di GenericStack<String> dopo la new posso scrivere GenericStack<>,
         * se il compilatore ha informazione sufficiente per inferire il tipo String.
         */
        GenericStack<String> p = new GenericStack<>(); // p pila String
        p.push("world!");
        // OK: essendo p un GenericStack<String>, il metodo push può ricevere un
        // parametro attuale di tipo String
        p.push("hello ");
        System.out.println(p); // stampo 2 strighe
        String s1 = p.pop();
        // OK: il metodo pop restituisce un valore di tipo String in quanto p è un
        // GenericStack<String>
        String s2 = p.pop();
        ...
        q.push(1);
        /*
         * OK: il metodo push si aspetta un argomento di tipo Integer, gli forniamo un
         * int che puo' essere convertito in Integer grazie all'autoboxing
         */
        q.push(2);
        System.out.println(q);// stampo 2, 1 interi
        q.push(q.pop() + q.pop());
        /*
         * OK: il metodo pop restituisce un Integer da cui la JVM estrae automaticamente
         * un int nel momento in cui vede che usiamo il valore per un'operazione
         * primitiva (+)
         */
        System.out.println(" ---> Stampo q = {2+1} ");
        ...
        /*
         * Il metodo toString(), restituendo il contenuto dello stack in formato String,
         * ci fornisce una versione stampabile per GenericStack di elementi di tipo
         * arbitrario (ma tutti dello stesso tipo in quanto, come visto precedentemente,
         * il compilatore ammette solo la push di elementi del tipo specificato nella
