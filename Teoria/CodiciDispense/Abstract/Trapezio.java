...
/**
 * Sottoclasse concreta di Poligono: sovrascrive i metodi per calcolare area e
 * perimetro, in piu' ha attributi e metodi specifici per i trapezi isosceli:
 * base maggiore, minore, altezza. Il numero dei lati e' fisso a 4.
 */
...
public class Trapezio extends Poligono {
    ...
    public Trapezio(double baseMinore, double baseMaggiore, double altezza) {
        ...
        assert baseMinore > 0 && baseMinore <= baseMaggiore && altezza > 0; // per mantenere l’invariante
