...
public class Bottiglia implements Comparable<Bottiglia> {
    ...
    /**
     * Siccome Bottiglia implements Comparable<Bottiglia>, dobbiamo fornire un
     * metodo compareTo():
     */
    public int compareTo(Bottiglia b) {
        return this.livello - b.livello;
    }
    // La differenza di livello e' 0 se le bottiglie hanno lo stesso livello, e' >0
    // se this ha livello maggiore, e' <0 altrimenti
