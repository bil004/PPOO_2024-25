...
public class Branch extends Tree {
    ...
    // Se la parte destra e' vuota il nodo piu' grande e' la radice. Altrimenti il
    // nodo piu' grande si trova a destra

    public boolean contains(int x) {
        // Usa la RICERCA BINARIA, in media richiede tempo log_2(n), dove n = numero dei
        // nodi. */
    ...
    public Tree insert(int x) {
        // Inseriamo x preservando l'invariante "albero di ricerca": dunque x va
        // inserito a sinistra se e' piu' piccolo della radice e a destra se e' piu'
        // grande.
        if (x < elem)
            left = left.insert(x);
