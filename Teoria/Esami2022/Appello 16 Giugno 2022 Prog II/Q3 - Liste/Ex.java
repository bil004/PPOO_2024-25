...
/*
 * 
Completate il metodo List f() nella classe List come segue. f() conta gli elementi della lista che sono maggiori o uguali a 0. Supponiamo che gli elementi che sono maggiori o uguali a 0 siano in numero pari. Allora f() restituisce la lista aggiungendo all'inizio un elemento (scelto come volete), in modo che che gli elementi che sono maggiori o uguali a 0 diventino in numero dispari. Altrimenti f() restituisce la lista immutata. Non modificate altro che il metodo. 
 */
import java.util.*;
