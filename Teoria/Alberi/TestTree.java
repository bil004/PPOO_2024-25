...
/* Per visualizzare a video un albero t, trascrivo t nella stringa t.toString(), con toString() ridefinito. 
    Il comando e': System.out.println(t), solita abbreviazione di System.out.println(t.toString()) 
*/
...
public class TestTree {
    public static void main(String[] args) {
        ...
        // Creo un albero t con n numeri interi casuali tra 0 e (n-1) (gli interi
        // estratti piu' volte compaiono una volta sola, altri interi tra 0 e (n-1) non
        // compaiono affatto).
        int n = 8;
        Tree t = new Leaf(); // l'albero t nasce vuoto
        for (int i = 0; i < n; i++)
            t = t.insert(r.nextInt(n)); // inserisco in t un elemento alla volta
